...
#define GAME_APP_VER "modicube-1.0.0.rc3"
...
/* Minor adjustment to max UV coords, to avoid pixel bleeding errors due to
 * rounding. */
...
enum FACE_CONSTS {
  FACE_XMIN = 0,
  FACE_BIT_XMIN = 1 << FACE_XMIN, /* Face X = 0 */
  FACE_XMAX = 1,
  FACE_BIT_XMAX = 1 << FACE_XMAX, /* Face X = 1 */
  FACE_ZMIN = 2,
  FACE_BIT_ZMIN = 1 << FACE_ZMIN, /* Face Z = 0 */
  FACE_ZMAX = 3,
  FACE_BIT_ZMAX = 1 << FACE_ZMAX, /* Face Z = 1 */
  FACE_YMIN = 4,
  FACE_BIT_YMIN = 1 << FACE_YMIN, /* Face Y = 0 */
  FACE_YMAX = 5,
  FACE_BIT_YMAX = 1 << FACE_YMAX, /* Face Y = 1 */
...
#define REGISTERNEW_URL "https://forms.gle/9h9SHFa9WpNY9tki9"
